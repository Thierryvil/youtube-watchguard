...
const Infos = ({ totalTimeToWatch, mostUsedWordsInTitles, mostUsedWordsInDescriptions }: InfoProps) => {
  return (
    <div className="px-3 py-4 space-y-4">
      ...
      <h1 className="text-3xl">Most Used Words In Titles:      {mostUsedWordsInTitles}</h1>
      <h1 className="text-3xl">Most Used Words In Description: {mostUsedWordsInDescriptions}</h1>
    </div>
  )
}
